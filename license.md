...
This license gives you broad permission to work with this software for any purpose, but requires you to contribute source code for changes, additions, and other software that you build with it, other than applications that simply invoke this software through the interfaces it exposes.
